      ...
      <View style={{ flex: 0.9 }}>
        <ScrollView overScrollMode="never" style={styles.scrollView}>
          <View style={styles.newsView}>
            ...
            {news.slice(0, 6).map(({ title, thumbnailURL, url, description }) => {
              return (
                <NewsCardComponent title={title} thumbnailURL={thumbnailURL} description={description} url={url} DOMAIN={DOMAIN} />
              );
            })}
          </View>
